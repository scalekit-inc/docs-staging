...
Open the <TermTip jargon="Admin Portal" /> from the app and select the "Directory Sync" tab. A list of Directory
...
<figure>
  ![Okta SCIM](@site/docs/dir-sync/assets/integrations/okta-scim/0.png)
...
<figure>
![Okta directory sync setup: Endpoint URL and one-time visible bearer token provided.](@site/docs/dir-sync/assets/integrations/okta-scim/5.png)
...
<figure>
  ![Okta app catalog: SCIM 2.0 Test App integration options displayed.](@site/docs/dir-sync/assets/integrations/okta-scim/1-scim-search.png)
...
<figure>
  ![Adding SCIM 2.0 Test App integration in Okta for app being onboarded](@site/docs/dir-sync/assets/integrations/okta-scim/2.png)
...
<figure>
  ![Naming the app 'Hero SaaS' during SCIM 2.0 Test App integration in Okta.](@site/docs/dir-sync/assets/integrations/okta-scim/3.png)
...
<figure>
  ![Enabling API Integration in Okta for app being onboarded.](@site/docs/dir-sync/assets/integrations/okta-scim/4.png)
...
<figure>
  ![Verifying SCIM credentials for Hero SaaS integration in Okta](@site/docs/dir-sync/assets/integrations/okta-scim/6.png)
...
<figure>
  ![Saving verified SCIM API integration settings for Hero SaaS in Okta](@site/docs/dir-sync/assets/integrations/okta-scim/7.png)
...
<figure>
  ![Granting provisioning permissions to Hero SaaS app in Okta SCIM integration](@site/docs/dir-sync/assets/integrations/okta-scim/4.1.png)
...
<figure>
  ![Assigning users to Hero SaaS in Okta: Options to assign to individuals or groups](@site/docs/dir-sync/assets/integrations/okta-scim/10.png)
...
<figure>
  ![Assigning users to Hero SaaS in Okta: Selecting individuals for access](@site/docs/dir-sync/assets/integrations/okta-scim/12.png)
...
<figure>
  ![Pushing group memberships to SCIM 2.0 Test App: Configuring the 'Avengers' group in Okta](@site/docs/dir-sync/assets/integrations/okta-scim/15.png)
