...
<figure>
  ![Setting up Directory Sync in the admin portal of an app being onboarded: OneLogin selected as the provider, awaiting configuration](@site/docs/dir-sync/assets/integrations/onelogin-scim/0-1.png)
  <figcaption>Setting up Directory Sync in the admin portal of an app being onboarded: OneLogin selected as the provider, awaiting configuration</figcaption>
</figure>

Click "Configure" to generate an Endpoint URL and Bearer token for your organization.

<figure>
  ![OneLogin directory sync setup: Endpoint URL and one-time visible bearer token provided](@site/docs/dir-sync/assets/integrations/onelogin-scim/0-2.png)
...
<figure>
  ![](@site/docs/dir-sync/assets/integrations/onelogin-scim/2.png)
</figure>

Click "Add App" to add a new application.

<figure>
  ![](@site/docs/dir-sync/assets/integrations/onelogin-scim/3.png)
  <figcaption>The OneLogin Applications page displays a list of apps with options to download JSON or add a new app.</figcaption>
</figure>

Search for "SCIM Provisioner with SAML (SCIM v2 Enterprise)"

<figure>
  ![](@site/docs/dir-sync/assets/integrations/onelogin-scim/4.png)
  <figcaption>OneLogin application search results for "SCIM Provisioner with SAML" displaying SCIM v2 Enterprise option.</figcaption>
</figure>

Name the app (e.g., "Hero SaaS App") and click "Save".

<figure>
  ![Configuring the portal settings for the application in OneLogin, including display name and icon options.](@site/docs/dir-sync/assets/integrations/onelogin-scim/5.png)
  <figcaption>Configuring the portal settings for the application in OneLogin, including display name and icon options.</figcaption>
</figure>

Go to the "Provisioning" tab, enable provisioning, and click "Save".

<figure>
  ![Setting up provisioning workflow for SCIM Provisioner with SAML in OneLogin, including options for user creation, deletion, and suspension actions.](@site/docs/dir-sync/assets/integrations/onelogin-scim/6.png)
  <figcaption>Setting up provisioning workflow for SCIM Provisioner with SAML in OneLogin, including options for user creation, deletion, and suspension actions.</figcaption>
</figure>
...
<figure>
  ![OneLogin Users dashboard displaying user information, including roles, last login time, and account status.](@site/docs/dir-sync/assets/integrations/onelogin-scim/7.png)
  <figcaption>OneLogin Users dashboard displaying user information, including roles, last login time, and account status.</figcaption>
</figure>
...
<figure>
  ![Assigning a new login to a user in OneLogin](@site/docs/dir-sync/assets/integrations/onelogin-scim/8.png)
...
<figure>
  ![OneLogin user provisioning dialog  for creating Kitty Flake in Hero SaaS App, with options to approve or skip the action.](@site/docs/dir-sync/assets/integrations/onelogin-scim/9.png)
  <figcaption>OneLogin user provisioning dialog  for creating Kitty Flake in Hero SaaS App, with options to approve or skip the action.</figcaption>
</figure>

The status should change to "Provisioned" within a few seconds.

<figure>
  ![OneLogin user profile for Kitty Flake displaying assigned applications, with Hero SaaS App provisioned and admin-configured.](@site/docs/dir-sync/assets/integrations/onelogin-scim/10.png)
  <figcaption>OneLogin user profile for Kitty Flake displaying assigned applications, with Hero SaaS App provisioned and admin-configured.</figcaption>
</figure>
...
<figure>
  ![OneLogin Directory Sync interface showing user details for Kitty Flake in Your organization, with SCIM integration status.](@site/docs/dir-sync/assets/integrations/onelogin-scim/11.png)
  <figcaption>OneLogin Directory Sync interface showing user details for Kitty Flake in Your organization, with SCIM integration status.</figcaption>
</figure>
...
<figure>
  ![Configuring a new mapping for group assignment in the Hero SaaS App using OneLogin.](@site/docs/dir-sync/assets/integrations/onelogin-scim/13.png)
...
<figure>
  ![Configuring field groups in OneLogin for SCIM provisioning, including SAML assertion and user provisioning options.](@site/docs/dir-sync/assets/integrations/onelogin-scim/12.png)
  <figcaption>Configuring field groups in OneLogin for SCIM provisioning, including SAML assertion and user provisioning options.</figcaption>
</figure>
...
<figure>
  ![Assigning the 'Hero SaaS App' to the 'hero_saas_viewer' role in OneLogin.](@site/docs/dir-sync/assets/integrations/onelogin-scim/14.png)
...
<figure>
  ![Viewing application assignment and status for 'Test User' in OneLogin, with 'Hero SaaS App' pending.](@site/docs/dir-sync/assets/integrations/onelogin-scim/16.png)
  <figcaption>Viewing application assignment and status for 'Test User' in OneLogin, with 'Hero SaaS App' pending.</figcaption>
</figure>
...
<figure>
  ![Approving 'Test User' for the 'Hero SaaS App' with assigned groups: Viewer and hero_saas_viewer.](@site/docs/dir-sync/assets/integrations/onelogin-scim/17.png)
  <figcaption>Approving 'Test User' for the 'Hero SaaS App' with assigned groups: Viewer and hero_saas_viewer.</figcaption>
</figure>
...
<figure>
  ![Directory sync status for Your Organization, showing linked groups and user count in OneLogin.](@site/docs/dir-sync/assets/integrations/onelogin-scim/18.png)
  <figcaption>Directory sync status for Your Organization, showing linked groups and user count in OneLogin.</figcaption>
</figure>
