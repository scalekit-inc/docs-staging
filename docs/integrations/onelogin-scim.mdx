...
<figure>
  ![Setting up Directory Sync in the admin portal of an app being onboarded: OneLogin selected as the provider, awaiting configuration](@site/docs/scim/assets/integrations/onelogin-scim/0-1.png)
...
<figure>
  ![OneLogin directory sync setup: Endpoint URL and one-time visible bearer token provided](@site/docs/scim/assets/integrations/onelogin-scim/0-2.png)
...
<figure>
  ![](@site/docs/scim/assets/integrations/onelogin-scim/2.png)
</figure>
...
<figure>
  ![Configuring the portal settings for the application in OneLogin, including display name and icon options.](@site/docs/scim/assets/integrations/onelogin-scim/5.png)
...
<figure>
  ![Setting up provisioning workflow for SCIM Provisioner with SAML in OneLogin, including options for user creation, deletion, and suspension actions.](@site/docs/scim/assets/integrations/onelogin-scim/6.png)
...
<figure>
  ![OneLogin Users dashboard displaying user information, including roles, last login time, and account status.](@site/docs/scim/assets/integrations/onelogin-scim/7.png)
...
<figure>
  ![OneLogin user provisioning dialog  for creating Kitty Flake in Hero SaaS App, with options to approve or skip the action.](@site/docs/scim/assets/integrations/onelogin-scim/9.png)
...
<figure>
  ![OneLogin user profile for Kitty Flake displaying assigned applications, with Hero SaaS App provisioned and admin-configured.](@site/docs/scim/assets/integrations/onelogin-scim/10.png)
...
<figure>
  ![OneLogin Directory Sync interface showing user details for Kitty Flake in Your organization, with SCIM integration status.](@site/docs/scim/assets/integrations/onelogin-scim/11.png)
...
<figure>
  ![Configuring a new mapping for group assignment in the Hero SaaS App using OneLogin.](@site/docs/scim/assets/integrations/onelogin-scim/13.png)
...
<figure>
  ![Configuring field groups in OneLogin for SCIM provisioning, including SAML assertion and user provisioning options.](@site/docs/scim/assets/integrations/onelogin-scim/12.png)
...
<figure>
  ![Assigning the 'Hero SaaS App' to the 'hero_saas_viewer' role in OneLogin.](@site/docs/scim/assets/integrations/onelogin-scim/14.png)
...
<figure>
  ![Viewing application assignment and status for 'Test User' in OneLogin, with 'Hero SaaS App' pending.](@site/docs/scim/assets/integrations/onelogin-scim/16.png)
...
<figure>
  ![Approving 'Test User' for the 'Hero SaaS App' with assigned groups: Viewer and hero_saas_viewer.](@site/docs/scim/assets/integrations/onelogin-scim/17.png)
...
<figure>
  ![Directory sync status for Your Organization, showing linked groups and user count in OneLogin.](@site/docs/scim/assets/integrations/onelogin-scim/18.png)
