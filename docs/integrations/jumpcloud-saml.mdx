...
title: "Configuring JumpCloud SAML for Single Sign-On"
description: "A step-by-step guide to integrating JumpCloud as an Identity Provider for Single Sign-On (SSO) functionality."
keywords: ["JumpCloud SAML", "Single Sign-On", "SSO", "Identity Provider", "Enterprise Application", "SAML Configuration", "Attribute Mapping", "User Assignment"]
---

# JumpCloud SAML

<Subtitle>
  Step-by-step guide to configure Single Sign-on with JumpCloud as the Identity
  Provider.
</Subtitle>
...
<figure>
  ![Download Metadata XML](@site/docs/sso/assets/integrations/jumpcloud/0.png)
...
<figure>
  ![Locate SSO Applications](@site/docs/sso/assets/integrations/jumpcloud/1.png)
...
<figure>
  ![Click on Add New
  Application](@site/docs/sso/assets/integrations/jumpcloud/2.png)
...
<figure>
  ...
  integration](@site/docs/sso/assets/integrations/jumpcloud/2-5.gif)
...
<figure>
  ![Click on Configure
  application](@site/docs/sso/assets/integrations/jumpcloud/3.png)
...
<figure>
  ![Upload Metadata XML under Service Provider
  Metadata](@site/docs/sso/assets/integrations/jumpcloud/4.png)
...
<figure>
  ![Copy SP Entity ID from your SSO Configuration
  Portal](@site/docs/sso/assets/integrations/jumpcloud/5.png)
  <figcaption>Copy SP Entity ID from your SSO Configuration Portal</figcaption>
</figure>

<figure>
  ![Paste it under IdP Entity ID and SP Entity ID on JumpCloud
  Portal](@site/docs/sso/assets/integrations/jumpcloud/6.png)
  <figcaption>
...
<figure>
  ![Copy ACS URL from SSO Configuration
  Portal](@site/docs/sso/assets/integrations/jumpcloud/7.png)
  <figcaption>Copy ACS URL from SSO Configuration Portal</figcaption>
</figure>

<figure>
  ![Paste it under Default URL on JumpCloud Portal
  ](@site/docs/sso/assets/integrations/jumpcloud/8.png)
...
<figure>
  ![Locate Attributes section on JumpCloud
  Portal](@site/docs/sso/assets/integrations/jumpcloud/9.png)
...
<figure>
  ...
  ](@site/docs/sso/assets/integrations/jumpcloud/10.png)
  <figcaption>Attribute mapping from SSO Configuration Portal </figcaption>
</figure>

<figure>
  ![Attribute Mapping on JumpCloud
  Portal](@site/docs/sso/assets/integrations/jumpcloud/10-5.gif)
...
<figure>
  ![Assign individuals or groups to your
  application](@site/docs/sso/assets/integrations/jumpcloud/11.png)
...
<figure>
  ...
  ](@site/docs/sso/assets/integrations/jumpcloud/12.png)
...
<figure>
  ![Paste Metadata URL on SSO Configuration
  Portal](@site/docs/sso/assets/integrations/jumpcloud/13.png)
...
<figure>
  ![Test SSO configuration](@site/docs/sso/assets/integrations/jumpcloud/14.png)
...
<figure>
  ![Enable SSO on
  JumpCloud](@site/docs/sso/assets/integrations/jumpcloud/15.png)
