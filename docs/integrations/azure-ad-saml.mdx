...
title: "Configuring Single Sign-On with Microsoft Entra ID (Azure AD) SAML"
description: "A step-by-step guide to setting up Single Sign-On (SSO) with Microsoft Entra ID as the Identity Provider using SAML. Learn how to integrate Entra ID with your application for enhanced security and user experience."
keywords: ["Microsoft Entra ID", "Azure AD", "SAML", "Single Sign-On", "SSO", "Identity Provider", "Enterprise Application", "Attribute Mapping", "User Assignment", "Metadata XML"]
---

# Entra ID (Azure AD) SAML

<Subtitle>
  Step-by-step guide to configure Single Sign-on with Microsoft Entra ID as the
  Identity Provider.{" "}
</Subtitle>
...
<figure>
  ![Download Metadata
  XML](@site/docs/sso/assets/integrations/azure-ad-saml/0.png)
...
<figure>
  ![Locate Enterprise
  applications](@site/docs/sso/assets/integrations/azure-ad-saml/1.png)
...
<figure>
  ![Click on New
  application](@site/docs/sso/assets/integrations/azure-ad-saml/2.png)
...
<figure>
  ...
  ID](@site/docs/sso/assets/integrations/azure-ad-saml/3.gif)
...
<figure>
  ...
  sign-on](@site/docs/sso/assets/integrations/azure-ad-saml/4.png)
...
<figure>
  ...
  file](@site/docs/sso/assets/integrations/azure-ad-saml/4-5.png)
...
<figure>
  ![Save button](@site/docs/sso/assets/integrations/azure-ad-saml/5.png)
...
<figure>
  ![Click on Edit ](@site/docs/sso/assets/integrations/azure-ad-saml/6.png)
...
<figure>
  ![**SSO Configuration
  Portal**](@site/docs/sso/assets/integrations/azure-ad-saml/7.png)
  <figcaption>SSO Configuration Portal</figcaption>
</figure>

<figure>
  ![**Microsoft Entra
  ID**](@site/docs/sso/assets/integrations/azure-ad-saml/8.png)
...
<figure>
  ...
  application](@site/docs/sso/assets/integrations/azure-ad-saml/9.gif)
...
<figure>
  ...
  URL](@site/docs/sso/assets/integrations/azure-ad-saml/10.png)
...
<figure>
  ...
  URL](@site/docs/sso/assets/integrations/azure-ad-saml/11.png)
...
<figure>
  ...
  SSO](@site/docs/sso/assets/integrations/azure-ad-saml/12.png)
...
<figure>
  ![Enable SSO on Entra
  ID](@site/docs/sso/assets/integrations/azure-ad-saml/13.png)
