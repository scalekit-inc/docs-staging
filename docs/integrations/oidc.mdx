...
title: "Configuring Single Sign-on using OIDC with any Identity Provider"
description: "A step-by-step guide to setting up OIDC-based Single Sign-on with any Identity Provider, including configuration, attributes mapping, and testing."
keywords: ["OIDC", "Single Sign-on", "SSO", "Identity Provider", "Custom Provider", "OpenID Connect", "Authentication", "Authorization"]
---

# OIDC

<Subtitle>
  Step-by-step guide to configure Single Sign-on using OIDC with any Identity
  Provider.
</Subtitle>
...
<figure>
  ...
  Configure](@site/docs/sso/assets/integrations/oidc-custom-provider/0.png)
...
<figure>
  ![Copy Redirect
  URI](@site/docs/sso/assets/integrations/oidc-custom-provider/1.png)
...
<figure>
  ...
  ](@site/docs/sso/assets/integrations/oidc-custom-provider/2.png)
...
<figure>
  ...
  Portal](@site/docs/sso/assets/integrations/oidc-custom-provider/3.png)
  <figcaption>
...
<figure>
  ...
  Portal](@site/docs/sso/assets/integrations/oidc-custom-provider/4.png)
  <figcaption>
...
<figure>
  ...
  Update](@site/docs/sso/assets/integrations/oidc-custom-provider/5.png)
...
<figure>
  ...
  Portal](@site/docs/sso/assets/integrations/oidc-custom-provider/6.png)
  <figcaption>
...
<figure>
  ![Test SSO
  Configuration](@site/docs/sso/assets/integrations/oidc-custom-provider/7.png)
...
<figure>
  ...
  ](@site/docs/sso/assets/integrations/oidc-custom-provider/8.png)
