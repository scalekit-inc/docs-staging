---
sidebar_position: 2
title: "Okta SAML Configuration Guide"
description: "A step-by-step guide to configuring Single Sign-on with Okta as the Identity Provider."
keywords: ["Okta SAML", "Single Sign-on", "SSO", "Identity Provider", "Okta Admin Console", "SAML 2.0", "Enterprise Application"]
...
<figure>
  ![Locate Applications](@site/docs/sso/assets/integrations/okta-saml/0.png)
...
<figure>
  ![Click on Create App
  Integration](@site/docs/sso/assets/integrations/okta-saml/1.png)
...
<figure>
  ![Select SAML 2.0 ](@site/docs/sso/assets/integrations/okta-saml/2.png)
...
<figure>
  ![General Settings for SAML
  integration](@site/docs/sso/assets/integrations/okta-saml/3.png)
...
<figure>
  ![Copy SSO URL on Configuration
  Portal](@site/docs/sso/assets/integrations/okta-saml/4.png)
  <figcaption>Copy SSO URL on Configuration Portal</figcaption>
</figure>

<figure>
  ![Paste SSO URL on Okta Admin
  Console](@site/docs/sso/assets/integrations/okta-saml/5.png)
...
<figure>
  ![Copy Audience URI on SSO Configuration
  Portal](@site/docs/sso/assets/integrations/okta-saml/6.png)
  <figcaption>Copy Audience URI on SSO Configuration Portal</figcaption>
</figure>

<figure>
  ![Paste Audience URI on Okta Admin
  Console](@site/docs/sso/assets/integrations/okta-saml/7.png)
...
<figure>
  ![Selecting preferences on Okta Admin
  Console](@site/docs/sso/assets/integrations/okta-saml/8.png)
...
<figure>
  ![Locate Assignments tab](@site/docs/sso/assets/integrations/okta-saml/11.png)
...
<figure>
  ...
  ](@site/docs/sso/assets/integrations/okta-saml/12.png)
...
<figure>
  ![Assign specific individuals or groups to
  app](@site/docs/sso/assets/integrations/okta-saml/13.png)
...
<figure>
  ![Preview SAML Assertion](@site/docs/sso/assets/integrations/okta-saml/14.png)
...
<figure>
  ![Feedback form after configuring
  SAML](@site/docs/sso/assets/integrations/okta-saml/15.png)
...
<figure>
  ![Copy Metadata URL from Okta Admin
  Console](@site/docs/sso/assets/integrations/okta-saml/16.png)
...
<figure>
  ...
  Portal](@site/docs/sso/assets/integrations/okta-saml/17.png)
...
<figure>
  ![Enable SSO on Okta Admin
  Console](@site/docs/sso/assets/integrations/okta-saml/19.png)
