...
<figure>
  ![Azure SCIM](@site/docs/dir-sync/assets/integrations/entra-id-scim/00.png)
...
<figure>
  ![Azure SCIM](@site/docs/dir-sync/assets/integrations/entra-id-scim/00-2.png)
...
<figure>
  ![Azure SCIM](@site/docs/dir-sync/assets/integrations/entra-id-scim/01.png)
...
<figure>
  ![Azure SCIM](@site/docs/dir-sync/assets/integrations/entra-id-scim/02.png)
...
<figure>
  ![Azure SCIM](@site/docs/dir-sync/assets/integrations/entra-id-scim/03.png)
...
<figure>
  ![Azure SCIM](@site/docs/dir-sync/assets/integrations/entra-id-scim/04.png)
  <figcaption>Creating a new application in Microsoft Entra ID.</figcaption>
</figure>
...
<figure>
  ![Azure SCIM](@site/docs/dir-sync/assets/integrations/entra-id-scim/05.png)
...
<figure>
  ![Azure SCIM](@site/docs/dir-sync/assets/integrations/entra-id-scim/06.png)
...
<figure>
  ![Azure SCIM](@site/docs/dir-sync/assets/integrations/entra-id-scim/07.png)
  <figcaption>Making sure the "Provision Microsoft Entra ID Users" is enabled.</figcaption>
</figure>

<figure>
  ![Azure SCIM](@site/docs/dir-sync/assets/integrations/entra-id-scim/08.png)
  <figcaption>Making sure the "Provision Microsoft Entra ID Users" is enabled.</figcaption>
</figure>
...
<figure>
  ![Azure SCIM](@site/docs/dir-sync/assets/integrations/entra-id-scim/010.png)
...
<figure>
  ![Azure SCIM](@site/docs/dir-sync/assets/integrations/entra-id-scim/020.png)
...
<figure>
  ![Azure SCIM](@site/docs/dir-sync/assets/integrations/entra-id-scim/013.png)
