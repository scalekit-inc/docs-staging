...
description:
  'Discover how to integrate Scalekit with various identity providers and authentication systems to
...
<Subtitle>
  Guides for Configuring Scalekit with Various Identity Providers, Directory Services, and
...
<CardTileWithImage
  ...
  title="SAML 2.0"
  description="Configure SAML Single Sign-on with any Identity Provider"
...
<CardTileWithImage
  ...
  description="Configure OIDC based Single Sign-on with any Identity Provider"
