...
keywords: ["OneLogin SAML", "Single Sign-On", "SSO", "Identity Provider", "Enterprise Application", "SAML Configuration", "Attribute Mapping", "User Assignment", "IdP Metadata", "Connection Testing"]
---

# OneLogin SAML

<Subtitle>
  Step-by-step guide to configure Single Sign-on with OneLogin as the Identity
  Provider.
</Subtitle>
...
<figure>
  ![Select SAML Custom Connector from drop down
  (GIF)](@site/docs/sso/assets/integrations/onelogin-saml/2-5.gif)
...
<figure>
  ...
  ](@site/docs/sso/assets/integrations/onelogin-saml/3.png)
...
<figure>
  ...
  ](@site/docs/sso/assets/integrations/onelogin-saml/4.png)
...
<figure>
  ![Paste it in Recipient, ACS URL Validator, and ACS(Consumer) URL fields on
  OneLogin Admin Portal](@site/docs/sso/assets/integrations/onelogin-saml/5.png)
  <figcaption>
    Paste it in Recipient, ACS URL Validator, and ACS(Consumer) URL fields on
    OneLogin Admin Portal
  </figcaption>
...
<figure>
  ![Copy Audience (Entity ID) on SSO Configuration
  Portal](@site/docs/sso/assets/integrations/onelogin-saml/6.png)
...
<figure>
  ...
  ](@site/docs/sso/assets/integrations/onelogin-saml/9.png)
...
<figure>
  ...
  ](@site/docs/sso/assets/integrations/onelogin-saml/10.png)
  <figcaption>Check attributes on SSO Configuration Portal </figcaption>
</figure>

<figure>
  ![Paste attributes on OneLogin Admin
  Portal](@site/docs/sso/assets/integrations/onelogin-saml/10-5.gif)
...
<figure>
  ![Locate Users under Users
  tab](@site/docs/sso/assets/integrations/onelogin-saml/11.png)
...
<figure>
  ![Select user to
  assign](@site/docs/sso/assets/integrations/onelogin-saml/12.png)
...
<figure>
  ![Add application to previously selected
  user](@site/docs/sso/assets/integrations/onelogin-saml/13.png)
...
<figure>
  ...
  drop-down](@site/docs/sso/assets/integrations/onelogin-saml/14.png)
...
<figure>
  ![Save user assignment to
  application](@site/docs/sso/assets/integrations/onelogin-saml/15.png)
...
<figure>
  ![Copy Issuer URL on OneLogin Admin
  Portal](@site/docs/sso/assets/integrations/onelogin-saml/16.png)
...
<figure>
  ...
  ](@site/docs/sso/assets/integrations/onelogin-saml/17.png)
...
<figure>
  ![Test SSO
  Configuration](@site/docs/sso/assets/integrations/onelogin-saml/18.png)
...
<figure>
  ![Enable SSO on Onelogin Admin
  Console](@site/docs/sso/assets/integrations/onelogin-saml/19.png)
