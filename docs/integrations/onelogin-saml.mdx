...
title: 'Configuring OneLogin SAML for Single Sign-On'
description:
  'A step-by-step guide to setting up Single Sign-On with OneLogin as the Identity Provider, including creating an
  enterprise application, configuring SAML, attribute mapping, assigning users, uploading IdP metadata, testing the
  connection, and enabling SSO.'
keywords:
  [
    'OneLogin SAML',
    'Single Sign-On',
...
<figure>
  ![Locate Applications](@site/docs/sso/assets/integrations/onelogin-saml/0.png)
...
<figure>
  ![Click on Add App](@site/docs/sso/assets/integrations/onelogin-saml/1.png)
...
<figure>
  ![Select SAML Custom Connector from drop down (GIF)](@site/docs/sso/assets/integrations/onelogin-saml/2-5.gif)
...
<figure>
  ![Click on Save](@site/docs/sso/assets/integrations/onelogin-saml/2.png)
...
<figure>
  ![Locate Configuration ](@site/docs/sso/assets/integrations/onelogin-saml/3.png)
...
<figure>
  ![Copy ACS (Consumer) URL on SSO Configuration Portal ](@site/docs/sso/assets/integrations/onelogin-saml/4.png)
...
<figure>
  ![Paste it in Recipient, ACS URL Validator, and ACS(Consumer) URL fields on OneLogin Admin
  Portal](@site/docs/sso/assets/integrations/onelogin-saml/5.png)
  <figcaption>
...
<figure>
  ![Copy Audience (Entity ID) on SSO Configuration Portal](@site/docs/sso/assets/integrations/onelogin-saml/6.png)
  <figcaption>Copy Audience (Entity ID) on SSO Configuration Portal</figcaption>
</figure>

<figure>
  ![Paste copied URL in Audience (EntityID) on OneLogin Admin
  Portal](@site/docs/sso/assets/integrations/onelogin-saml/7.png)
...
<figure>
  ![Locate Save](@site/docs/sso/assets/integrations/onelogin-saml/8.png)
...
<figure>
  ![Locate Parameters tab ](@site/docs/sso/assets/integrations/onelogin-saml/9.png)
...
<figure>
  ![Check attributes on SSO Configuration Portal ](@site/docs/sso/assets/integrations/onelogin-saml/10.png)
  <figcaption>Check attributes on SSO Configuration Portal </figcaption>
</figure>

<figure>
  ![Paste attributes on OneLogin Admin Portal](@site/docs/sso/assets/integrations/onelogin-saml/10-5.gif)
...
<figure>
  ![Locate Users under Users tab](@site/docs/sso/assets/integrations/onelogin-saml/11.png)
...
<figure>
  ![Select user to assign](@site/docs/sso/assets/integrations/onelogin-saml/12.png)
...
<figure>
  ![Add application to previously selected user](@site/docs/sso/assets/integrations/onelogin-saml/13.png)
...
<figure>
  ![Select application from drop-down](@site/docs/sso/assets/integrations/onelogin-saml/14.png)
...
<figure>
  ![Save user assignment to application](@site/docs/sso/assets/integrations/onelogin-saml/15.png)
...
<figure>
  ![Copy Issuer URL on OneLogin Admin Portal](@site/docs/sso/assets/integrations/onelogin-saml/16.png)
...
<figure>
  ![Paste Issuer URL on SSO Configuration Portal ](@site/docs/sso/assets/integrations/onelogin-saml/17.png)
...
<figure>
  ![Test SSO Configuration](@site/docs/sso/assets/integrations/onelogin-saml/18.png)
...
<figure>
  ![Enable SSO on Onelogin Admin Console](@site/docs/sso/assets/integrations/onelogin-saml/19.png)
