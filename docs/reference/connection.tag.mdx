...
\| `attribute_mapping`<br />_Object_ \| Array of attribute mappings using which the user information received from the Identity Provider is normalized. Example: <code> <br />\{ <br/>&nbsp;&nbsp; "email": "email",<br />&nbsp;&nbsp; "family\*name": "lastName", <br />&nbsp;&nbsp; "given_name": "firstName",<br />&nbsp;&nbsp;&nbsp;"sub": "nameid" <br />\} </code> \|
\| `create_time`<br />\_string\* \| Timestamp at which this connection record was created in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format. For Example: `2021-10-05T14:48:00.000Z` \|
\| `update_time`<br />\_string\* \| Timestamp at which this connection record was last updated in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601) format. For Example: `2021-10-10T14:48:00.000Z` \|
