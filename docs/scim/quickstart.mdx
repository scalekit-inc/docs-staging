...
<SimpleCode>createUserAccount()</SimpleCode> to perform the necessary business logic — in this case, creating a user account.
  ...
  src={{
    data: {
      ...
      raw_attributes: {
        ...
        emails: [{ primary: true, type: 'work', value: 'santhosh@acmecorp.com' }],
