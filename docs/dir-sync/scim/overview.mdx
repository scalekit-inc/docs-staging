...
SCIM is a HTTP based protocol and uses structured [JSON](https://datatracker.ietf.org/doc/html/rfc7159) payloads to exchange resource information between the SCIM client and server. To identify the SCIM protocol resources, the `application/scim+json` media type is used.
...
Some of the most common SCIM Clients are [Okta](https://www.okta.com), [Microsoft Entra ID (fka Azure AD)](https://www.microsoft.com/en-in/security/business/identity-access/microsoft-entra-id).
...
- [Core SCIM Schema](https://datatracker.ietf.org/doc/html/rfc7643#section-2)
- [Enterprise User Schema](https://datatracker.ietf.org/doc/html/rfc7643#section-3)
- [Group Schema](https://datatracker.ietf.org/doc/html/rfc7643#section-4)
...
Refer to our [Webhooks](/dir-sync/webhooks) documentation to learn more on how you can use webhooks to listen for changes in the directory and update the user's roles in your application.
