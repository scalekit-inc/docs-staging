---
title: 'Admin Portal for Directory Sync Integration: Empowering IT Admins with Scalekit'
description:
  "Discover how Scalekit's Admin Portal enables IT admins to configure Directory Sync independently, reducing
  engineering and support team overhead. Explore API and no-code integration options for effortless Directory Sync
  setup."
keywords:
  [
    'Directory Sync',
...
<Subtitle>Empower your customers to configure and manage Directory Sync settings by themselves</Subtitle>

The Admin Portal allows enterprise organizations to easily configure connections between your app and their identity or directory providers. By providing a self-serve portal, you can reduce back-and-forth communication between your team and your customers' teams.
Scalekit fully hosts and manages the Admin Portal, offering two integration options:
...
- Exercise caution, as anyone with this link can view and update their organization's Directory Sync settings
...
The API will return a JSON object containing the <SimpleCode>location</SimpleCode> property, which is the URL to the Admin Portal.
...
Access the <SimpleCode>location</SimpleCode> property and set it as the <SimpleCode>src</SimpleCode> attribute of an iframe in your web pages.
...
The Admin Portal can be customized to match your brand's logo and colors. Refer to the [Customize Admin Portal Guide](docs/sso/domain-and-theme-customization) for more information.
