...
keywords: ["Scalekit", "Admin Portal Customization", "Custom Domain", "CNAME Configuration", "Custom Theme", "Brand Identity", "Logo", "Accent Color", "Favicon"]
---
...
You can set up a custom domain, upload your company logo, choose colors that match your brand palette, and add a favicon. These simple customization options ensure that the Admin Portal looks and feels like a seamless extension of your application.
