...
- Rotate your <SimpleCode>secret </SimpleCode>regularly. See the [best practices for managing secrets](/sso/launch-checklist#client-secrets-essentials).
  :::
