...
URL with appropriate social connection provider details.
...
<SimpleCode>code</SimpleCode> in the browser. Exchange the <SimpleCode>code</SimpleCode> for user profile
