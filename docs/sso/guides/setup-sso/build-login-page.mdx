...
<figure className="width-50">
  ...
  <figcaption> Example with Password and Social auth methods</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>Identifier-driven login. Example: Sign in to Google account</figcaption>
</figure>
...
<figure className="width-50">
  ...
  <figcaption>Display SSO and other authentication options. Example Cal.com</figcaption>
</figure>
...
public ResponseEntity < Map < String, String >> loginHandler(
    ...
    try {
      String url = scalekit.authentication()
        .getAuthorizationUrl(redirectUrl, options).toString();
