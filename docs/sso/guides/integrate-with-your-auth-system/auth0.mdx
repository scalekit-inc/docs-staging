...
description: "Learn how to integrate Scalekit with Auth0 applications for seamless Single Sign-on Authentication. This guide provides a step-by-step walkthrough of configuring Scalekit as an OpenID Connect provider in your Auth0 tenant."
keywords: ["Scalekit", "Auth0", "Single Sign-on", "SSO", "OpenID Connect", "OIDC", "Enterprise Connections", "Identity Management", "Security", "Authentication"]
---

# Integrate with Auth0

<Subtitle>
  Learn how to integrate Scalekit with Auth0 via OpenID Connect (OIDC)
</Subtitle>
...
<figure>
  ![Scalekit - Auth0
  Integration](@site/docs/sso/assets/integrations/auth0/0.png)
  <figcaption>Scalekit - Auth0 Integration</figcaption>
</figure>
...
<figure>
  ...
  Dashboard](@site/docs/sso/assets/integrations/auth0/1.png)
...
<figure>
  ![Add new Redirect URI in Scalekit
  Dashboard](@site/docs/sso/assets/integrations/auth0/2.png)
...
<figure>
  ![Add domains for Home Realm Discovery in
  Auth0](@site/docs/sso/assets/integrations/auth0/3.png)
  <figcaption>
