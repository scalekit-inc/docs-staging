...
description:
  'Learn how to verify your SSO connection using Okta as the identity provider. Follow our comprehensive guide to test
  and validate Single Sign-On scenarios with Scalekit, ensuring seamless integration for your enterprise customers.'
keywords:
  [
    'SSO Testing',
    'Okta Integration',
...
:::tip You can [customize the admin portal](/sso/domain-and-theme-customization) and theme it according to your
