...
title: "Inspect Claims in ID Token with Scalekit"
description: "Understand how to inspect and validate claims in an ID Token issued by Scalekit. Learn about the structure of ID Tokens, including their payload, and the significance of various claims for user profile information."
