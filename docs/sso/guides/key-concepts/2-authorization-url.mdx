...
description:
  "Learn how to construct the authorization URL in Scalekit to initiate the Single Sign-On (SSO) flow. Understand the
  required and optional parameters, usage notes, and see code examples for integrating Scalekit's authorization URL in
  your application using various SDKs."
keywords:
  [
    'Scalekit',
    'Authorization URL',
