...
- The <SimpleCode className="text--semibold">sub</SimpleCode> field combines the <SimpleCode className="text--semibold">connection_id</SimpleCode> and the provider's unique identifier.
