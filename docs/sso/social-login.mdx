...
description: "Learn how to integrate social login functionality into your application using Scalekit. Enable OAuth login with providers like Google, Microsoft, and GitHub to enhance security and user experience."
keywords: ["Social Login", "Scalekit", "OAuth", "Single Sign-On", "SSO", "Google Login", "Microsoft Login", "GitHub Login", "B2B SaaS Security", "Identity Provider"]
---
...
<Subtitle>
  Enable OAuth login to your application with Google, Microsoft,
  GitHub, etc.
</Subtitle>
...
<figure>
  ![How Scalekit
  works](@site/docs/sso/assets/single-sign-on/quickstart/scalekit_social.png)
