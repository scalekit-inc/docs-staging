...
After implementing Single Sign-on using our [Quickstart guide](/sso/quickstart), now it's time to validate your integration for all possible scenarios. To make your integration testing easy and also comprehensive, we have already setup your development environment with the two key components:
