...
slug: overview
id: overview
title: "Introduction to Single Sign-On (SSO) - Streamlining User Access"
description: "Learn about Single Sign-On (SSO), its benefits, and how it works with protocols like SAML and OIDC. Discover how Scalekit simplifies SSO integration for secure and compliant user access."
keywords: ["Single Sign-On", "SSO", "SAML", "OIDC", "Scalekit", "User Access", "Security", "Compliance", "Identity Provider", "Service Provider"]
---
...
<figure>
  ![SP initiated SSO
  workflow](@site/docs/sso/assets/guides/sp-initiated-sso.png)
