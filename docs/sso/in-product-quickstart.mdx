...
keywords: ["Single Sign-On", "SSO", "Scalekit", "Identity Providers", "SAML", "OIDC", "B2B SaaS", "Authentication", "API Integration", "Security"]
---
...
- Rotate your <SimpleCode>secret </SimpleCode>regularly. See the <Link href="/sso/guides/key-concepts/manage-client-secrets" target="_blank"> best practices for managing secrets</Link>
