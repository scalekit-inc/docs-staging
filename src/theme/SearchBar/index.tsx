...
> & {
  ...
  customPlaceholder?: string; // Added placeholder prop
};
...
function DocSearch({
  contextualSearch,
  externalUrlRegex,
  placeholder, // Destructured placeholder prop
  ...props
}: DocSearchProps) {
      ...
      {isOpen &&
        ...
        createPortal(
          <DocSearchModal
            ...
            placeholder={placeholder || translations.placeholder} // Use custom placeholder if provided
...
export default function SearchBar(): JSX.Element {
  ...
  const { placeholder } = siteConfig.themeConfig
    .algolia as DocSearchProps;
  return (
    <DocSearch
      {...(siteConfig.themeConfig.algolia as DocSearchProps)}
      placeholder="Dive into the docs—what's your query?"
    />
  );
}
