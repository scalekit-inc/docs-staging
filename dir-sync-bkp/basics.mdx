...
source for user information and access rights. Organizations expect B2B applications to accommodate
their directory provider requirements. Consequently, those B2B application architects (like youself)
must design systems capable of interfacing with various directory providers used by their customers.

The landscape of directory providers is diverse, ranging from in-house solutions to popular
platforms such as Okta, Azure, OneLogin, and JumpCloud. For you to support this variety of providers
traditionally requires significant developer resources and time investment. This challenge arises
from the need to implement compatibility with each unique directory provider used by current
...
<figure>
  ...
  Providers](@site/docs/dir-sync/assets/basics-2.png)
  <figcaption>User onboarding flow across Your App, Scalekit, and Directory Providers</figcaption>
</figure>

SCIM provisioning allows your application to:

1. Automatically create and delete users and keep user details updated.
...
1. Dive into our [Quickstart](/dir-sync/quickstart) guide to learn how to set up SCIM provisioning
   for your app. This practical guide will walk you through the implementation process step-by-step.
